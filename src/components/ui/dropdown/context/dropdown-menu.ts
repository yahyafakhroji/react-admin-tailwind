...
const DropdownMenu = createContext<any>(null);

export const DropdownMenuContextProvider = DropdownMenu.Provider;

export const DropdownMenuContextConsumer = DropdownMenu.Consumer;
